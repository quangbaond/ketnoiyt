    ...
    <div id="game">
        <div class="info">
            <a-space align="center" style="display: flex;">
                ...
                <a-typography.Title style="color: #000; font-size: 18px;" class="notranslate ">
                    Trung tâm đại lý
                </a-typography.Title>
            </a-space>
        </div>
            ...
            <a-row v-if="typeNewAcc === 'normal'">
                <a-col span="24">
                    <a-card>
                        ...
                        <a-textarea style="color: #000; background-color: rgb(255 216 219 / 1);" v-model:value="refRegister">
