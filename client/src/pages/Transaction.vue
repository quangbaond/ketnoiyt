...
<template>
    <div id="profile">
            ...
            <a-row gutter="10" style="text-align: center; justify-content: center;">
                ...
                <!-- <a-col :span="8">
                    <a-space direction="vertical">
                        ...
                        <a-typography.Title level="5" style="color: #000; font-size: 20px;">
                            {{ formattedBalanceUser }}
                        </a-typography.Title>
                    </a-space>
                </a-col>
        ...
        <div class="transaction">
            <!-- <h4 style="color: #000;">Bih4 động số dư</h3> -->
            ...
            <div class="transaction_box" v-for="balance in balanceFluctuations" :key="balance._id"
                ...
                <a-space direction="vertical">
                    ...
                    <a-typography.Title style="color: #000; display: block; height: 30px;font-size: 16px;">
                        Lý do: {{ balance.reson ?? 'Không có lý do' }}
                    </a-typography.Title>

                    <div style="color: #000; display: block; height: 30px;font-size: 16px;">
                        Trạng thái: {{ balance.status === 'pending' ? 'Đang chờ xử lý' : balance.status === 'accept' ?
                        'Thành công'
                        : 'Từ chối'}}
                    </div>
                    <div style="color: #000; display: block; height: 30px;font-size: 16px;" v-if="balance.note">
            ...
            <div v-else>
                <a-typography.Title
                    style="color: #000; display: block; height: 30px;font-size: 18px; text-align: center;">
                    Không có dữ liệu
                </a-typography.Title>
            </div>
        </div>
